...
/**
 * Created by NitiN on 10/26/2017.
 */
...
public class OtpVerifi extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.otp_verifi);
    ...
    void initiateVerification(boolean skipPermissionCheck) {
        ...
        if (intent != null) {
            String phoneNumber = intent.getStringExtra(PhoneVerifi.INTENT_PHONENUMBER);
            String countryCode = intent.getStringExtra(PhoneVerifi.INTENT_COUNTRY_CODE);
    ...
    private void startTimer() {
        resend_timer.setClickable(false);
        resend_timer.setTextColor(ContextCompat.getColor(OtpVerifi.this, R.color.sendotp_grey));
        new CountDownTimer(30000, 1000) {
            ...
            public void onFinish() {
                ...
                resend_timer.setTextColor(ContextCompat.getColor(OtpVerifi.this, R.color.colorPrimary));
            }
        }.start();
    }
