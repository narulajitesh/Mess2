...
public class PhoneVerifi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.phone_verifi);

        mPhoneNumber = (EditText) findViewById(R.id.phoneNumber);
        mSmsButton = (Button) findViewById(R.id.smsVerificationButton);
        countrycode = (EditText)findViewById(R.id.cc);
        ...
        spinner.addCountryIsoSelectedListener(new CountrySpinner.CountryIsoSelectedListener() {
            @Override
            public void onCountryIsoSelected(String iso) {
       ...
       spinner.addCountryIsoSelectedListener(new CountrySpinner.CountryIsoSelectedListener() {
            ...
            public void onCountryIsoSelected(String selectedIso) {
                if (selectedIso != null) {
                    ...
                    countrycode.setText(Iso2Phone.getPhone(mCountryIso));
                    // force update:
    ...
    private void openActivity(String phoneNumber) {
        Intent verification = new Intent(this, OtpVerifi.class);
